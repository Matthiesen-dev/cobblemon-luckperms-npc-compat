package dev.matthiesen.common.cobblemon_luckperms_npc_compat.commands;

import com.mojang.brigadier.CommandDispatcher;
import com.mojang.brigadier.context.CommandContext;
import dev.matthiesen.common.cobblemon_luckperms_npc_compat.CobblemonLuckPermsNPCCompat;
import dev.matthiesen.common.cobblemon_luckperms_npc_compat.interfaces.ICommand;
...
public class Example implements ICommand {
        ...
        dispatcher.register(
                Commands.literal("example")
                        .requires(src -> ModPermissions.checkPermission(
                                src,
                                CobblemonLuckPermsNPCCompat.permissions.EXAMPLE_PERMISSION
                        ))
    ...
    private int normal(CommandContext<CommandSourceStack> ctx) {
        ...
        if (player != null) {
            ...
            if (ModPermissions.checkPlayerPermission(player, CobblemonLuckPermsNPCCompat.permissions.EXAMPLE_COOL_PERMISSION)) {
